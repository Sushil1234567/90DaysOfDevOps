The core components of Linux ?
    ...
    The Core of Linux comprises of following components : 
       ...
       *systemd/init: Both are used to initialise (start) Linux services to manage and monitor system services. Difference being systemd is used in modern linux flavours like Ubuntu, Centos etc. and init was used in older flavours of linux like redhat-Linux.
